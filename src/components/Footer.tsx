...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-[#1E2530] text-[#FAF6F0]/90 pt-16 pb-8 border-t border-white/10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
        ...
        <div className="space-y-4">
          ...
          <div className="flex gap-4">
            <a href="#" className="text-white/60 hover:text-[#E88C7D] transition-colors" title="Facebook">
              <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
                <path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z" />
              </svg>
            </a>
            <a href="#" className="text-white/60 hover:text-[#E88C7D] transition-colors" title="Instagram">
              <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
            ...
            <a href="#" className="text-white/60 hover:text-[#E88C7D] transition-colors" title="Youtube">
              <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
        ...
        {/* Shop Links */}
        <div>
          <h4 className="font-semibold text-sm uppercase tracking-wider mb-6 text-[#E88C7D]">Quick Shop</h4>
        ...
        {/* Customer Care */}
        <div>
          <h4 className="font-semibold text-sm uppercase tracking-wider mb-6 text-[#E88C7D]">Customer Care</h4>
          <ul className="space-y-3.5 text-sm text-white/70">
        ...
        {/* Contact Info */}
        <div className="space-y-4">
          <h4 className="font-semibold text-sm uppercase tracking-wider mb-6 text-[#E88C7D]">Get in Touch</h4>
          <ul className="space-y-4 text-sm text-white/70">
            <li className="flex items-start gap-3">
              <MapPin className="w-5 h-5 text-[#E88C7D] flex-shrink-0" />
              <span>{address}</span>
            </li>
            <li className="flex items-center gap-3">
              <Phone className="w-5 h-5 text-[#E88C7D] flex-shrink-0" />
              <span>{phone}</span>
            </li>
            <li className="flex items-center gap-3">
              <Mail className="w-5 h-5 text-[#E88C7D] flex-shrink-0" />
              <span>{email}</span>
            </li>
          </ul>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-white/40">
        <p>{footerText}</p>
        <p className="font-light text-[#FAF6F0]/60">Design inspired by Luxury Fashion Layouts</p>
      </div>
    </footer>
  );
};
